...
class UsagePayloadFactory(object):
    ...
    def create(
        ...
        FieldValidator.require(
            "aggregation", aggregation, AggregationType, allow_none=False
        )
        FieldValidator.require(
            "time_grouping_interval",
            time_grouping_interval,
        ...
        FieldValidator.require("time_range", time_range, TimeRange, allow_none=False)
        FieldValidator.require(
        ...
        if take:
            FieldValidator.require("limit", take.limit, Number, allow_none=False)
            FieldValidator.require(
